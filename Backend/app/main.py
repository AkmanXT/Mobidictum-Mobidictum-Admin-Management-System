...
# Create FastAPI app
app = FastAPI(
    title="Mobidictum Admin Management System",
...
async def root():
    ...
    return {
        "message": "Mobidictum Admin Management System",
        "version": "1.0.0",
        "docs": "/docs",
        "health": "/health"
    }
...
async def combined_startup_event():
    ...
    logger.info("Starting Mobidictum Admin Management System")
...
async def shutdown_event():
    ...
    logger.info("🛑 Shutting down Mobidictum Admin Management System")
